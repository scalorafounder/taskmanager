...
function AppContent() {
  ...
  return (
    ...
    >
      ...
      {/* Group hint */}
      <AnimatePresence>
        {tasks.length >= 2 && tab === 'inprogress' && (
          <motion.div
            initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
            className="mx-4 mt-2 px-3 py-1.5 rounded-xl flex items-center gap-2"
            style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}
          >
            <svg width="10" height="10" viewBox="0 0 16 16" fill="none">
              <circle cx="8" cy="8" r="7" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5"/>
              <path d="M8 7v4M8 5.5v.5" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
            <span className="text-xs" style={{ color: 'rgba(255,255,255,0.25)' }}>
              Hold &amp; drag a task onto another to group them
            </span>
          </motion.div>
        )}
      </AnimatePresence>
